 ...
 *  90             |  PC11  | DueEEPROM Control Pin (SAM3X Pin 93)
 *
 * USB pin         |  PORT
 * ----------------+--------
 *  ID             |  PB11
...
{
  // Column Meanings:
  //  Base Address -               \hardware\arduino\sam\system\CMSIS\Device\ATMEL\sam3xa\include\sam3x8e.h,
  //  Bit Within Base Address -    \hardware\arduino\sam\system\CMSIS\Device\ATMEL\sam3xa\include\pio\pio_sam3x8e.h,
  //  Peripheral ID -              \hardware\arduino\sam\system\CMSIS\Device\ATMEL\sam3xa\include\sam3x8e.h,
  //  Associated Signal -          \hardware\arduino\sam\system\libsam\include\pio.h,
  //  Default Pin Configuration -  \hardware\arduino\sam\system\libsam\include\pio.h,
  //  Pin Attributes -             \hardware\arduino\sam\cores\arduino\Arduino.h,
  //  Analog pin (Arduino) -       \hardware\arduino\sam\cores\arduino\Arduino.h,
  //  ADC Channel (SAM) -          \hardware\arduino\sam\cores\arduino\Arduino.h,
  //  PWM Channel -                \hardware\arduino\sam\cores\arduino\Arduino.h,
  //  TC Channel -                 \hardware\arduino\sam\cores\arduino\Arduino.h
  // 
  // 0 .. 53 - Digital pins
  // ----------------------
  // 0/1 - UART (Serial)
  ...
  // 90 - 16u2 EEPROM Control
  { PIOC, PIO_PC11,          ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // Pin 90
  // END
...
void init( void )
{
  ...
  // Turn on the external crystal for the slow clock
  ...
  // Disable pull-up on EEPROM Control Pin
  digitalWrite(PINS_16U2_EEPROM, LOW);
